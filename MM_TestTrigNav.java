...
public class MM_TestTrigNav extends MM_OpMode {
    ...
    public void runProcedures(){
        ...
        while(opModeIsActive()) {
            if(gamepad1.a) {
                robot.drivetrain.driveToPosition(TARGET_X, TARGET_Y, .6, TARGET_HEADING, ROTATE_FACTOR, -25, 0, false, false);//rotateFactor speeds up the rotate and is based on the distance we are moving
            }
        }
    }
}